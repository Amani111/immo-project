...
<head>
  ...
  <!-- CSS Files -->
  {{-- <link rel="stylesheet" type="text/css" href="{{('backend/assets/css/corporate-ui-dashboard.css?v=1.0.0')}}"  /> --}}
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <script src="{{('backend/assets/js/plugins/swiper-bundle.min.js')}}" type="text/javascript"></script>
  <script>
  ...
  <script src="{{('backend/assets/js/corporate-ui-dashboard.min.js?v=1.0.0')}}"></script>
</html>
