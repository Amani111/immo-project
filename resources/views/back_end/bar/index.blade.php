...
<div class="row" >
    ...
    <div class="col-md-9" >
        ...
        <h2> Gestion des publicités Bar </h2>

    </div>

    <div class="col-md-3">

        <a class="btn btn-success" href="{{route('bar.create')}}"> <i class="fa-solid fa-plus"></i> Créer</a>
     ...
     <tr>
      ...
      @endif
       ...
       <td>
          ...
          <a class="btn btn-sm btn-warning"  href="{{ route('bar.edit',$pub->id) }}"><i class="fa-regular fa-pen-to-square"></i></a>
   
           {!! Form::open(['method' => 'DELETE','route' => ['bar.destroy', $pub->id],'style'=>'display:inline']) !!}
